...
use PKP\Listeners\SendPublishedNotification;
import('lib.pkp.classes.observers.events.PublicationPublishedEvent');
import('lib.pkp.classes.observers.listeners.SendPublishedNotification');
import('lib.pkp.classes.observers.events.TestQueueEvent');
...
class PKPEventServiceProvider extends EventServiceProvider {
	 ...
	 */
	protected $listen = [
		PublicationPublishedEvent::class => [
			SendPublishedNotification::class,
			TestQueueEvent::class,
		],
	];
